        ...
        <nav class="navbar navbar-default navbar-static-top top_black_header">
            <div class="container">
                <div class="navbar-header">
                    <img src="http://wannahelp.com/whapi/public/images/wh_home_logo.png" style="width:70px;height:70px;float:left;margin-right: 50px;"> 
                    ...
                    <a class="navbar-brand" id="open_location_selector" style="margin-top: 20px;">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><button class="btn btn-primary btn_slider_post_free pull-right" data-toggle="modal" data-target="#myModal"><span>POST FREE</span></button> </li>
                        
                        <li><a class="my_account_text" style="margin-top: 15px;margin-left: 50px;" data-toggle="modal" data-target="#register_login_wrap"><span class="fa fa-user"></span>&nbsp;My Account</a></li>
