...
<div id="app">
        ...
        <div class="top_location_selector_content">
            ...
            <div class="search_by_location_wrap">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <input id="pac-input-tp" onkeypress="return change_location(event)" type="text" class="form-control search_query" placeholder="Select your city" />
                </div>  
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right  main-menu">
                        ...
                        @else
                            Debug Status: Not logged in
                        @endif    
                                                        
                        </li>    
                        <li style="margin-top: -3px;"><button onclick="show_modal1()" class="btn btn-primary btn_slider_post_free pull-right" >POST FREE</button> </li>
                        
                        <li style="margin-top: 3px;padding: 0px 25px 0px 25px"><a style="color:white;" href="{{(new \App\Http\Controllers\Helper)->get_url()}}" ><span class="fa fa-home"></span>&nbsp;Home</a></li>
                        
                        @if(Auth::user())
                         <li style="margin-top: 3px; padding: 0px 20px 0px 0px;">
                            <a href="#" style="margin-top: 3px;color: white;background: #000000;" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span style="font-size: 19px;" class="fa fa-globe"></span><span></span></a>
                              <ul id="notifications" class="dropdown-menu" style="width: 360px;background: #000000;">
                            <div class="line"></div>      
                              <li><a style="color: white;background: #000000;" href="{{(new \App\Http\Controllers\Helper)->get_url()}}/notifications"><center>See all notifications</center></a></li>  
                              </ul>
                          </li>
                        @endif
                        @if(Auth::user())
    ...
    <div class="modal fade" id="PostModal" role="dialog">
      ...
      <div class="modal-content">
          <div class="modal-header">
            ...
            <center style="margin-bottom: -20px;"><span class = "row"><label>Select Type:</label>
                <span id="myRadioGroup">
                 <input style="margin-left: 35px;" type="radio" checked="checked" name="types" value="Broadcast"  />&nbsp;Broadcast
                 <input style="margin-left: 35px;" type="radio" name="types" value="Swap"  />&nbsp;Swap
                 <input style="margin-left: 35px;" type="radio" name="types" value="LocalVocal"  />&nbsp;LocalVocal
                 </span>
                </div> 
            </span></center>
            <!-- Broadcast Data -->
		    ...
		    <div class="col-sm-4"><textarea name="description" class="form-control" id="description" style="resize: none;width: 450px !important;height: 70px;width: 450px !important;"></textarea></div>
		    </div>
			<br><br>
		    <span style="margin-left:50px"><b>Category</b> <br><br>
	        <center style="margin-top: -50px;margin-left: 143px;">  
                @foreach($categories as $category)
                   @if($category->id != 1)
                    <span name="{{$category->id}}"><img id="bc{{$category->id}}" style="width: 60px;" onclick="choose_category_bc({{$category->id}})" src="<?php echo url('public/images/category/')?>/{{$category->logo_image}}"></span> 
				    @endif	                   
				@endforeach
            </center><br><br>   
		    ...
		    <div class="col-sm-4"><input style="width: 300px !important;" id="pac-input-modal_bc" name="pac-input-modal" type="text" class="form-control search_query" placeholder="Search in your city" /></div>
		    ...
		    @if(!Auth::user())
            <div class = "row">	                
		    <div class="col-sm-3"><span style="margin-left:50px"><b>Name</b> </span></div>
		    <div class="col-sm-4"><input id="name" name="name" type="text" class="form-control search_query" placeholder="Your name" /></div>
		   
		    </div>
		    <br>
		    <div class = "row">	                
		    <div class="col-sm-3"><span style="margin-left:50px"><b>Mobile</b> </span></div>
		    <div class="col-sm-4"><input id="mobile" name="mobile" type="text" class="form-control search_query" title="Enter your mobile number to recive OTP" placeholder="Mobile Number" /></div>
		   
		    </div>
		    <br>
		     <div class = "row">	                
		    <div class="col-sm-3"><span style="margin-left:50px"><b>Your Location</b> </span></div>
		    <div class="col-sm-4"><input id="pac-input-modal" name="city" type="text" class="form-control search_query" placeholder="Your Location" /></div>
		   ...
		   <div class="modal-footer">
		       <span style="font-size: 14px;float: left;">By clicking 'Submit' you agree to our Terms of Use & Posting Rules </span>
		        <!-- @if(!Auth::user())
		            <span style="font-style: italic;padding-right: 20px;">Please Log in / Register to add a Broadcast </span>
		            <button type="button" onclick="show_registration_form()" class="btn btn-success">Login</button> 
		        @endif -->
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <!--  <button id="post" type="submit" class="btn btn-primary submit">
                    Post
		    ...
		    <div id="swap" style="display: block">
		    <form id="example-form" method="post" enctype="multipart/form-data">      
		    ...
		    <div class="col-sm-4"><textarea name="caption" id="caption" style="resize: none;height:50px;width:300px"></textarea></div>
		    </div>
		    <div class = "row">	
		    <div class="col-sm-3"><span style="margin-left:50px"><b>Description&nbsp;&nbsp;&nbsp;</b></span> </div>
		    <div class="col-sm-4"><textarea name="description" id="desciption" style="resize: none;height:85px;width:450px"></textarea></div>
		    </div>
		    <br>
		    <div class = "row">	
		    ...
		    <span style="margin-left:50px"><b>Category</b> <br>
	        <center style="margin-left: 143px;">  
                @foreach($categories as $category)
                 @if($category->id != 1)
					 <span name="{{$category->id}}"><img id="sw{{$category->id}}" style="width: 60px;" onclick="choose_category_sw({{$category->id}})" src="<?php echo url('public/images/category/')?>/{{$category->logo_image}}"></span> 
				 @endif
				@endforeach
            </center><br><br>   
            ...
            <div class = "row">	                
		    <div class="col-sm-3"><span style="margin-left:50px"><b>Location</b> </span></div>
		    <div class="col-sm-4"><input  class="form-control" name="pac-input-modal" id="pac-input-modal_sw" type="text" class="form-control search_query" placeholder="Search in your city" /></div>
		   
		    </div>
		    <br/>
		    
		      <div class = "row">	                
		    <div class="col-sm-12"><span style="margin-left:50px"><b>Wishing to swap for</b> </span>
		    <span id="myRadioSwap">
            ...
            <div class = "row">
		    <center><div id="swap_area" style="display:block;">
                   <div class="col-sm-5" style="margin-left: 100px;"><input id="goods" name="goods" type="text" class="form-control search_query" placeholder="Enter Goods you wish to trade for" /></div>
                   <div class="col-sm-4"><input id="price" name="price" type="text" class="form-control search_query" placeholder="Sell for Price INR" /> </div>
		   ...
		   <div class="modal-footer">
		    ...
		    <div id="localvocal" style="display: block">
		    <form id="example-form" method="post" enctype='multipart/form-data'>      
		     ...
		     <div class="modal-body" style="overflow: visible;z-index: 5000;">
		        ...
		        <div class = "row">	
		            <div class="col-sm-3"><span style="margin-left:50px"><b>Description&nbsp;&nbsp;&nbsp;</b></span> </div>
		            <div class="col-sm-4 PreviewClass"><textarea name="description" id="description" style="resize: none;height:85px;width:450px"></textarea></div>
		        </div>
		        <br>
		        <div class = "row">	
		            <div class="col-sm-3"><span style="margin-left:35px"><b>Upload Images&nbsp;&nbsp;&nbsp;</b></span></div>
		            ...
		            <input type="file" name="s1_file[]" multiple="multiple"></div>
		        </div>
			    <br>
		        <span style="margin-left:50px"><b>Category</b> <br>
	            <center style="margin-left: 143px;">  
                    @foreach($categories as $category)
                     @if($category->id != 1)
					   <span name="{{$category->id}}"><img id="lv{{$category->id}}" style="width: 60px;" onclick="choose_category_lv({{$category->id}})" src="<?php echo url('public/images/category/')?>/{{$category->logo_image}}"></span>  
                    @endif
				    @endforeach
                </center><br><br>   
                ...
                <div class = "row">	                
		            <div class="col-sm-3"><span style="margin-left:50px"><b>Location</b> </span></div>
		            <div class="col-sm-4"><input  class="form-control" name="pac-input-modal" id="pac-input-modal_lv" type="text" class="form-control search_query" placeholder="Search in your city" /></div>
  ...
  <div class="modal fade" id="PostModal1" role="dialog">
        <div class="modal-dialog" style="width: 55%;">
  ...
  <div class="modal fade" id="myModal" role="dialog">
   ...
   <div class="modal fade" id="PostModal2" role="dialog">
        <div class="modal-dialog" style="width: 55%;">
          ...
          <div class="modal-header">
	        ...
	        <center style="margin-top: -50px;margin-left: 143px;">  
                @foreach($categories as $category)
                    ...
                    <span name="{{$category->id}}"><img id="cat_bc{{$category->id}}" style="width: 60px;" onclick="edit_choose_category_bc({{$category->id}})" src="<?php echo url('public/images/category/')?>/{{$category->logo_image}}"></span> 
            ...
            <div class = "row">	                
		    <div class="col-sm-3"><span style="margin-left:50px"><b>Location</b> </span></div>
		    <div class="col-sm-4"><input id="pac-input-modal_bc" name="pac-input-modal_bc" type="text" class="form-control search_query" placeholder="Search in your city" /></div>
  ...
  <div class="modal fade" id="EditPostModal_sw" role="dialog">
      ...
      <div class="modal-content">
          <div class="modal-header">
	        ...
	        <center style="margin-left: 143px;">  
                @foreach($categories as $category)
					 <span name="{{$category->id}}"><img id="cat_sw{{$category->id}}" style="width: 60px;" onclick="edit_choose_category_sw({{$category->id}})" src="<?php echo url('public/images/category/')?>/{{$category->logo_image}}"></span> 
				@endforeach
            </center><br><br>   
            
            <div class = "row">	                
		    <div class="col-sm-3"><span style="margin-left:50px"><b>Location</b> </span></div>
		    <div class="col-sm-4"><input  class="form-control" name="pac-input-modal_sw" id="pac-input-modal_sw" type="text" class="form-control search_query" placeholder="Search in your city" /></div>
          ...
          <div class="modal-header">
	        ...
	        <center style="margin-top: -50px;margin-left: 143px;">  
                @foreach($categories as $category)
                    ...
                    <span name="{{$category->id}}"><img id="cat{{$category->id}}" style="width: 60px;" onclick="edit_choose_category_lv({{$category->id}})" src="<?php echo url('public/images/category/')?>/{{$category->logo_image}}"></span> 
...
$(document).on('click', '.icon_close', function (e) {
  ...
  // alert($(this).val());
    ...
    $("form#example-form").submit(function(){
   ...
   // var edit_numArray_bc = [];
     $.ajax({
        ...
        success: function(result) {
         ...
         $(".modal-body #pac-input-modal_bc").val( result[0].location );
...
//console.log(file.fileName);
  ...
  /* function initialize() {
    ...
    var autocomplete_tp = new google.maps.places.Autocomplete(input,options1);
    /*
...
function load_more(page,p_type,i,keyword,location){
    if(p_type == "")
     var type = $(".page_search_wrap_left_ul li.active").text();
     else
     {type = p_type;}
    ...
    /* var page_bc_cat = 1;
      ...
      var page_lv_cat = 1;*/
       ...
       // document.cookie = "page_bc="+ page;
        ...
        {
        //page_lv_cat++; //page number increment
        load_more(getCookie("page_lv"),'LocalVocal',i,getCookie("keyword"),getCookie("keyword"),getCookie("location")); //load content   
        }
...
$(document).on('click', '.icon_close', function (e) {
   ...
   function vue1()
   {
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        props: ["userId", "convId", "receptorName"],
        data: function() {
            return {
                message: {
                    text: "",
        ...
        mounted: function() {
            var e = this;
            database.ref("/chats/" + this.convId).on("value", function(t) {
        ...
        methods: {
            ...
            sendMessage: function() {
                var e = this;
                this.message.text.length > 0 ? database.ref("/chats/" + this.convId).push({
                    userId: this.userId,
