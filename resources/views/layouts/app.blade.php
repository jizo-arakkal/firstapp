...
<head>
    ...
    <link rel="icon" href="{{ asset('images/swapnear_icon-01.png') }}" type="image/x-icon">
...
<!--<link href="{{ asset('css/jquery.typeahead.css') }}" rel="stylesheet">-->
    ...
    <script src="{{asset('js/newWaterfall.js')}}"></script> 
...
<div id="app">
    ...
    <div id="top_location_selector" style="z-index:1">
                ...
                <nav class="navbar navbar-default navbar-static-top top_black_header">
                  <div class="container">
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand" href="{{(new \App\Http\Controllers\Helper)->get_url()}}" style="width: 160px;"><img style="width: 100%; float: left;" src="{{asset('images/swapnear_logo-02.png')}}"></a>
                      ...
                      <ul class="nav navbar-nav navbar-right">
                        ...
                        @if(Auth::user())
                          <li>
                            ...
                            {{Auth::user()->name}} &nbsp;@endif<span><img src="<?php echo url('images/')?>//down-arrow.png" alt="" /></span></a>
        ...
        <!--    <div class="container">-->
        <!--        <div class="navbar-header">-->
        <!--            <img style="width: 150px;float: left;margin-top: 12px;margin-right: 35px;" src="{{asset('images/swapnear_logo-01.png')}}">-->
                    <!-- Collapsed Hamburger -->
                                    ...
                                    <ul class="category_scroller">
        								 ...
        								 <li>
                                             <div class="cat_img_wrap">
                                                ...
                                                <div name="{{$category->id}}"><img id="cat_bc{{$category->id}}" style="width: 60px;" onclick="edit_choose_category_bc({{$category->id}})" src="<?php echo url('images/category/')?>/{{$category->logo_image}}"> 
                                                </div>
                                             </div>
                                    ...
                                    <ul class="category_scroller">
        								 ...
        								 <li>
                                             <div class="cat_img_wrap">
                                                ...
                                                <div name="{{$category->id}}"><img id="cat_sw{{$category->id}}" style="width: 60px;" onclick="edit_choose_category_sw({{$category->id}})" src="<?php echo url('images/category/')?>/{{$category->logo_image}}"> 
                                                </div>
                                             </div>
                                             <p  style="color:black;">{{$category->category_title}}</p>
                                         </li>
                                    ...
                                    <ul class="category_scroller">
        								 ...
        								 <li>
                                             <div class="cat_img_wrap">
                                                ...
                                                <div name="{{$category->id}}"><img id="cat_lv{{$category->id}}" style="width: 60px;" onclick="edit_choose_category_lv({{$category->id}})" src="<?php echo url('images/category/')?>/{{$category->logo_image}}"> 
                                                </div>
                                             </div>
                                             <p  style="color:black;">{{$category->category_title}}</p>
                                         </li>
