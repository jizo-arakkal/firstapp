                                ...
                                <ul class="category_scroller">
    								 ...
    								 <li>
                                         <div class="cat_img_wrap">
                                            ...
                                            <div name="{{$category->id}}"><img id="bc{{$category->id}}" style="width: 52px;" onclick="choose_category_bc({{$category->id}})" src="<?php echo url('images/category/')?>/{{$category->logo_image}}"> 
                                            </div>
                                         </div>
                                ...
                                <ul class="category_scroller">
    								 ...
    								 <li>
                                         <div class="cat_img_wrap">
                                            ...
                                            <div name="{{$category->id}}"><img id="sw{{$category->id}}" style="width: 52px;" onclick="choose_category_sw({{$category->id}})" src="<?php echo url('images/category/')?>/{{$category->logo_image}}"> 
                                            </div>
                                         </div>
                                         <p  style="color:black;">{{$category->category_title}}</p>
                                     </li>
                                    ...
                                    <ul class="category_scroller">
        								 ...
        								 <li>
                                             <div class="cat_img_wrap">
                                                ...
                                                <div name="{{$category->id}}"><img id="lv{{$category->id}}" style="width: 60px;" onclick="choose_category_lv({{$category->id}})" src="<?php echo url('images/category/')?>/{{$category->logo_image}}"> 
                                                </div>
                                             </div>
                                             <p  style="color:black;">{{$category->category_title}}</p>
                                         </li>
