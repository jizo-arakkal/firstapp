                             ...
                             <ul class="category_scroller">
								 ...
								 <li>
                                     <div class="cat_img_wrap">
                                        ...
                                        <div name="<?php echo e($category->id); ?>" onclick="change_category(<?php echo e($category->id); ?>)"><img id="cat<?php echo e($category->id); ?>" src="<?php echo url('public/images/category/')?>/<?php echo e($category->logo_image); ?>"> 
                                        </div>
        ...
        <div class="tab-content">
            <div id="tab_broadcast" class="tab-pane fade in active">                 
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding_right_0 padding_left_0">
					<?php $__currentLoopData = $paid_broadcasts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paid_broadcast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                         <div class="top_user_listing">
                             <div class="wh_profile_pic_top">
                                 <?php if($paid_broadcast->is_online): ?>
                             ...
                             <div class="wh_brdcast">
                                <?php echo e($paid_broadcast->description); ?>

                             </div>
                             <div class="wh_name_chat">
                                 <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                     <p><i class="fa fa-diamond" aria-hidden="true" style="color: #3cc0c7;"></i>&nbsp;<?php echo e($paid_broadcast->name); ?></p>
                                     <p class="distance"><?php echo e($paid_broadcast->location); ?></p>
                                 </div>
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="broadcast_content"></div>
                     ...
                     <div class="ajax-loading-bc"><img src="http://wannahelp.com/whapi/public/images/loading.gif" /></div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 top_ad_column" 
            ...
            <div id="tab_swap" class="tab-pane fade">
                <div id="waterfall_content">
                 ...
                 <div class="ajax-loading-sw"><img src="http://wannahelp.com/whapi/public/images/loading.gif" /></div>
            ...
            <div id="tab_localvocal" class="tab-pane fade">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding_right_0 padding_left_0">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="float:  right;">
                        <!--<div class="lv_suggestions_wrap">
                            ...
                            <ul class="suggestion_ul">
                                <?php $__currentLoopData = $sugg_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sugg_users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                   <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                       <img class="sugg_pic" src="<?php echo url('public/images/profile.png');?>">
                                   </div>
                                   <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                      <p class="sugg_name"><?php echo e($sugg_users->name); ?></p>
                                      <p class="sugg_place"><?php echo e($sugg_users->location); ?></p>
                                   </div>
                                   <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                    ...
                    <div class="clearfix"></div>
                    <div class="ajax-loading-lv"><img src="http://wannahelp.com/whapi/public/images/loading.gif" /></div>
