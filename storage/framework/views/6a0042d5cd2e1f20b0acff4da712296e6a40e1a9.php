...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('public/images/swapnear_icon-01.png')); ?>" type="image/x-icon">
    <link href="<?php echo e(asset('public/css/app.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('public/css/custom.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('public/css/flags.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('public/css/dd.css')); ?>" rel="stylesheet">
	...
	<link href="<?php echo e(asset('public/css/toastr.css')); ?>" rel="stylesheet"> 
	 <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/css/semantic.css')); ?>">
<!--<link href="<?php echo e(asset('public/css/jquery.typeahead.css')); ?>" rel="stylesheet">-->
	<link href="<?php echo e(asset('public/css/fileinput.min.css')); ?>" rel="stylesheet">
	
	
    <script src="<?php echo e(asset('public/js/jquery.min.js')); ?>"></script>  
    <script src="<?php echo e(asset('public/js/jquery.cookie.js')); ?>"></script>  
    <script src="<?php echo e(asset('public/js/jquery.typeahead.js')); ?>"></script>  
    <script src="<?php echo e(asset('public/js/newWaterfall.js')); ?>"></script> 
    <script src="<?php echo e(asset('public/js/fileinput.min.js')); ?>"></script> 
    <script src="<?php echo e(asset('public/js/theme.min.js')); ?>"></script> 
    ...
    <script src="<?php echo e(asset('public/js/myapp.js')); ?>"></script> 
...
<div id="app">
    ...
    <div id="top_location_selector" style="z-index:1">
                ...
                <nav class="navbar navbar-default navbar-static-top top_black_header">
                  <div class="container">
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>" style="width: 160px;"><img style="width: 100%; float: left;" src="<?php echo e(asset('public/images/swapnear_logo-02.png')); ?>"></a>
                      ...
                      <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php if(Auth::user()): ?>
                          <li>
                            ...
                            <?php echo e(Auth::user()->name); ?> &nbsp;<?php endif; ?><span><img src="<?php echo url('public/images/')?>//down-arrow.png" alt="" /></span></a>
        ...
        <!--    <div class="container">-->
        <!--        <div class="navbar-header">-->
        <!--            <img style="width: 150px;float: left;margin-top: 12px;margin-right: 35px;" src="<?php echo e(asset('public/images/swapnear_logo-01.png')); ?>">-->
                    <!-- Collapsed Hamburger -->
                                    ...
                                    <ul class="category_scroller">
        								 ...
        								 <li>
                                             <div class="cat_img_wrap">
                                                ...
                                                <div name="<?php echo e($category->id); ?>"><img id="cat_bc<?php echo e($category->id); ?>" style="width: 60px;" onclick="edit_choose_category_bc(<?php echo e($category->id); ?>)" src="<?php echo url('public/images/category/')?>/<?php echo e($category->logo_image); ?>"> 
                                                </div>
                                             </div>
                                    ...
                                    <ul class="category_scroller">
        								 ...
        								 <li>
                                             <div class="cat_img_wrap">
                                                ...
                                                <div name="<?php echo e($category->id); ?>"><img id="cat_sw<?php echo e($category->id); ?>" style="width: 60px;" onclick="edit_choose_category_sw(<?php echo e($category->id); ?>)" src="<?php echo url('public/images/category/')?>/<?php echo e($category->logo_image); ?>"> 
                                                </div>
                                             </div>
                                             <p  style="color:black;"><?php echo e($category->category_title); ?></p>
                                         </li>
                                    ...
                                    <ul class="category_scroller">
        								 ...
        								 <li>
                                             <div class="cat_img_wrap">
                                                ...
                                                <div name="<?php echo e($category->id); ?>"><img id="cat_lv<?php echo e($category->id); ?>" style="width: 60px;" onclick="edit_choose_category_lv(<?php echo e($category->id); ?>)" src="<?php echo url('public/images/category/')?>/<?php echo e($category->logo_image); ?>"> 
                                                </div>
                                             </div>
                                             <p  style="color:black;"><?php echo e($category->category_title); ?></p>
                                         </li>
...
<div class="modal fade" id="LoginPhone" role="dialog" >
  ...
  <div id="register_login_wrap" class="modal fade in" role="dialog"> 
    ...
    <!-- Scripts -->
     <script src="<?php echo e(asset('public/js/semantic.js')); ?>"></script> 
    <script src="<?php echo e(asset('public/js/app.js')); ?>"></script>
    <script src="<?php echo e(asset('public/js/custom.js')); ?>"></script>
	<script src="<?php echo e(asset('public/js/jquery.typeahead.js')); ?>"></script>
	<script src="<?php echo e(asset('public/js/newWaterfall.js')); ?>"></script> 
	<script src="<?php echo e(asset('public/js/jquery.cookie.js')); ?>"></script> 
	<script src="<?php echo e(asset('public/js/jssocials.js')); ?>"></script> 
	...
	<script src="<?php echo e(asset('public/js/share.js')); ?>"></script>
