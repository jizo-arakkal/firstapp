                             ...
                             <ul class="category_scroller">
								 ...
								 <li>
                                     <div class="cat_img_wrap">
                                        ...
                                        <div name="<?php echo e($category->id); ?>" onclick="change_category(<?php echo e($category->id); ?>)"><img id="cat<?php echo e($category->id); ?>" src="<?php echo url('images/category/')?>/<?php echo e($category->logo_image); ?>"> 
                                        </div>
