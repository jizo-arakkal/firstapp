...
<head>
    ...
    <?php echo $__env->yieldContent('seo-meta'); ?> 
    <title><?php echo e(config('app.name', 'Swap Near')); ?></title>
    <link rel="icon" href="<?php echo e(asset('images/swapnear_icon-01.png')); ?>" type="image/x-icon">
    <link href="<?php echo e(asset('css/app.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/custom.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/flags.css')); ?>" rel="stylesheet">
	...
	<link href="<?php echo e(asset('css/toastr.css')); ?>" rel="stylesheet"> 
	 <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/semantic.css')); ?>">
<!--<link href="<?php echo e(asset('css/jquery.typeahead.css')); ?>" rel="stylesheet">-->
    ...
    <script src="<?php echo e(asset('js/newWaterfall.js')); ?>"></script> 
...
<div id="app">
    ...
    <div id="top_location_selector" style="z-index:1">
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                        <div class="pre_loc_items" onclick="getlocation('Bangalore')">
                            <div><img src="http://wannahelp.com/whapi/images/cities/Bangalore.png" alt="Bangalore" style="width: 142px;"></div>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                        <div class="pre_loc_items" onclick="getlocation('Chennai')">
                            <div><img src="http://wannahelp.com/whapi/images/cities/Chennai.png" alt="Chennai" style="width: 142px;"></div>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                        <div class="pre_loc_items" onclick="getlocation('Mumbai')">
                            <div><img src="http://wannahelp.com/whapi/images/cities/Mumbai.png" alt="Mumbai" style="width: 142px;"></div>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                        <div class="pre_loc_items" onclick="getlocation('Delhi')">
                            <div><img src="http://wannahelp.com/whapi/images/cities/Delhi.png" alt="Delhi" style="width: 142px;"></div>
                            <div class="pre_loc_name">
                                Delhi
                            </div>
                            <div class="clearfix"></div> 
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                        <div class="pre_loc_items" onclick="getlocation('Hyderabad')">
                            <div><img src="http://wannahelp.com/whapi/images/cities/Hyderabad.png" alt="Hyderabad" style="width: 142px;"></div>
                            <div class="pre_loc_name">
                                Hyderabad
                            </div>
                            <div class="clearfix"></div> 
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                        <div class="pre_loc_items" onclick="getlocation('Jaipur')">
                            <div><img src="http://wannahelp.com/whapi/images/cities/Jaipur.png" alt="Hyderabad" style="width: 142px;"></div>
                            <div class="pre_loc_name">
                                Jaipur
                            </div>
                            <div class="clearfix"></div> 
                ...
                <nav class="navbar navbar-default navbar-static-top top_black_header">
                  <div class="container">
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>" style="width: 160px;"><img style="width: 100%; float: left;" src="<?php echo e(asset('images/swapnear_logo-02.png')); ?>"></a>
                      <!-- Trigger/Open The Modal -->
                        ...
                        <span style="float:left; position:relative; padding-left:40px;"><span class="location_icon">&nbsp;&nbsp;<i class="fa fa-map-marker"></i></span><input id="pac-input-tp" onkeypress="return change_location(event)" type="text" class="search_city_textbox" placeholder="Enter your city" />
                          ...
                          <div class="modal-content popup-content">
                            <span class="close" style="font-size:32px;">&times;</span>
                                ...
                                <div class="row pop-city" id="iconsdiv">
                                    <div class="container">
                                        <ul class="city-ul">
                                            <li class="city-li"><a href="#" class="city-link"><img src="http://wannahelp.com/whapi/images/cities/Bangalore.png" alt="Bangalore" style="width: 100px; height=100px; padding: 5px 0;"></a><p style="text-align:center;">bangalore</p></li>
                                            <li class="city-li"><a href="#" class="city-link"><img src="http://wannahelp.com/whapi/images/cities/Chennai.png" alt="Chennai" style="width: 100px; height=100px; padding: 5px 0;"></a><p style="text-align:center;">Chennai</p></li>
                                            <li class="city-li"><a href="#" class="city-link"><img src="http://wannahelp.com/whapi/images/cities/Mumbai.png" alt="Mumbai" style="width: 100px; height=100px; padding: 5px 0;"></a><p style="text-align:center;">Mumbai</p></li>
                                            <li class="city-li"><a href="#" class="city-link"><img src="http://wannahelp.com/whapi/images/cities/Delhi.png" alt="Delhi" style="width: 100px; height=100px; padding: 5px 0;"></a><p style="text-align:center;">Delhi</p></li>
                                            <li class="city-li"><a href="#" class="city-link"><img src="http://wannahelp.com/whapi/images/cities/Chennai.png" alt="Hyderabad" style="width: 100px; height=100px; padding: 5px 0;"></a><p style="text-align:center;">Hyderabad</p></li>
                                            <li class="city-li"><a href="#" class="city-link"><img src="http://wannahelp.com/whapi/images/cities/Jaipur.png" alt="Jaipur" style="width: 100px; height=100px; padding: 5px 0;"></a><p style="text-align:center;">Jaipur</p></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                      <ul class="nav navbar-nav navbar-right">
                        ...
                        <li style=""><a class="top_menu" style="margin-top: 3px;color:white;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>" ><span style="font-size: 22px;" class="fa fa-home"></span>&nbsp;</a></li>
                        
                        <?php if(Auth::user()): ?>
                         <li>
                            <a href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/notifications" style="margin-top: 3px;color: white;background: #000000;"><span style="font-size: 22px;" class="fa fa-globe"></span>&nbsp;<span id="number_of_notif" style="color:yellow;"></span></a>
                               <ul id="notifications" class="dropdown-menu" style="width: 250px;background: #000000;">
                             <div class="line"></div>       
                               <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/notifications"><center style="font-size:10px">See All Notifications</center></a></li>  
                              </ul>
                          </li>
                        <?php endif; ?>
                        <?php if(Auth::user()): ?>
                          <li>
                            <a href="#" style="margin-top: 3px;color: white;background: #000000;" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user-circle" style="font-size: 21px;"></i>, <?php if(Auth::user()->username!=""): ?><?php echo e(Auth::user()->username); ?> <?php else: ?>
                            <?php echo e(Auth::user()->name); ?> &nbsp;<?php endif; ?><span><img src="<?php echo url('images/')?>//down-arrow.png" alt="" /></span></a>
                              <ul class="dropdown-menu newsfeed-home" style="background: #000000;">
                                <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/user/<?php echo e(Auth::user()->user_id); ?>"><i class="fa fa-eye"></i>&nbsp; View Profile</a></li>
                                <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/credits"><i class="fa fa-money"></i>&nbsp; Credits</a></li>
                                <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/messages"><i class="fa fa-comment-o"></i>&nbsp; Messages</a></li>
                                 <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/profile"><i class="fas fa-sliders-h"></i>&nbsp; Settings</a></li>
                                <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/logout"><i class="fas fa-sign-out-alt"></i> &nbsp; Logout</a></li>
                              </ul>
                          </li>
                        <?php endif; ?>
        ...
        <!--    <div class="container">-->
        <!--        <div class="navbar-header">-->
        <!--            <img style="width: 150px;float: left;margin-top: 12px;margin-right: 35px;" src="<?php echo e(asset('images/swapnear_logo-01.png')); ?>">-->
                    <!-- Collapsed Hamburger -->
        ...
        <!--                <?php echo e(config('app.name', 'Wannahelp')); ?>-->
        <!--            </a> -->-->
        ...
        <!--                <li style=""><a class="top_menu" style="margin-top: 3px;color:white;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>" ><span style="font-size: 19px;" class="fa fa-home"></span>&nbsp;Home</a></li>-->
                        
        <!--                <?php if(Auth::user()): ?>-->
        <!--                 <li>-->
        <!--                    <a href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/notifications" style="margin-top: 3px;color: white;background: #000000;"><span style="font-size: 19px;" class="fa fa-globe"></span>&nbsp;Notifications<span></span></a>-->
                              <!-- <ul id="notifications" class="dropdown-menu" style="width: 250px;background: #000000;">
                            <!-- <div class="line"></div>       -->
                              <!-- <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/notifications"><center style="font-size:10px">See All Notifications</center></a></li>  
        <!--                      </ul> -->-->
        ...
        <!--                <?php if(Auth::user()): ?>-->
        <!--                  <li>-->
        <!--                    <a href="#" style="margin-top: 3px;color: white;background: #000000;" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Welcome, <?php if(Auth::user()->username!=""): ?><?php echo e(Auth::user()->username); ?> <?php else: ?>-->
        <!--                    <?php echo e(Auth::user()->name); ?> &nbsp;<?php endif; ?><span><img src="<?php echo url('images/')?>//down-arrow.png" alt="" /></span></a>-->
        <!--                      <ul class="dropdown-menu newsfeed-home" style="background: #000000;">-->
        <!--                        <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/user/<?php echo e(Auth::user()->user_id); ?>"><i class="fa fa-eye"></i>&nbsp; View Profile</a></li>-->
        <!--                        <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/credits"><i class="fa fa-money"></i>&nbsp; Credits</a></li>-->
                                <!--<li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/chat"><i class="fa fa-comment-o"></i>&nbsp; Messages</a></li> -->
        <!--                        <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/messages"><i class="fa fa-comment-o"></i>&nbsp; Messages</a></li>-->
        <!--                         <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/profile"><i class="fas fa-sliders-h"></i>&nbsp; Settings</a></li>-->
        <!--                        <li><a style="color: white;background: #000000;" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/logout"><i class="fas fa-sign-out-alt"></i> &nbsp; Logout</a></li>-->
        <!--                      </ul>-->
                                    ...
                                    <ul class="category_scroller">
        								 ...
        								 <li>
                                             <div class="cat_img_wrap">
                                                ...
                                                <div name="<?php echo e($category->id); ?>"><img id="cat_bc<?php echo e($category->id); ?>" style="width: 60px;" onclick="edit_choose_category_bc(<?php echo e($category->id); ?>)" src="<?php echo url('images/category/')?>/<?php echo e($category->logo_image); ?>"> 
                                                </div>
                                             </div>
                                    ...
                                    <ul class="category_scroller">
        								 ...
        								 <li>
                                             <div class="cat_img_wrap">
                                                ...
                                                <div name="<?php echo e($category->id); ?>"><img id="cat_sw<?php echo e($category->id); ?>" style="width: 60px;" onclick="edit_choose_category_sw(<?php echo e($category->id); ?>)" src="<?php echo url('images/category/')?>/<?php echo e($category->logo_image); ?>"> 
                                                </div>
                                             </div>
                                             <p  style="color:black;"><?php echo e($category->category_title); ?></p>
                                         </li>
                                    ...
                                    <ul class="category_scroller">
        								 ...
        								 <li>
                                             <div class="cat_img_wrap">
                                                ...
                                                <div name="<?php echo e($category->id); ?>"><img id="cat_lv<?php echo e($category->id); ?>" style="width: 60px;" onclick="edit_choose_category_lv(<?php echo e($category->id); ?>)" src="<?php echo url('images/category/')?>/<?php echo e($category->logo_image); ?>"> 
                                                </div>
                                             </div>
                                             <p  style="color:black;"><?php echo e($category->category_title); ?></p>
                                         </li>
...
<div class="modal fade" id="LoginPhone" role="dialog" >
  ...
  <div id="register_login_wrap" class="modal fade in" role="dialog"> 
                          ...
                          <div class="tab-content">
                            <div class="tab-pane active" id="register">
                                ...
                                <div class="">
                                  ...
                                  <div class="form-group-popup">
                                      <!-- <select name="countries" id="countries" style="width:300px;">
                                        <option value='91' data-image="images/msdropdown/icons/blank.gif" data-imagecss="flag ad" data-title="India">India</option>
                             ...
                             <!-- <center> <a onclick="register_mobile()">Register via Mobile & OTP </a></center>
                               <center>or<center> -->
                              <a href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/fb"><button class="loginBtn loginBtn--facebook">Sign in using Facebook</button></a>
                              <a href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/google"><button class="loginBtn loginBtn--google">Sign in using Google</button></a>
                            ...
                            <div class="tab-pane" id="login">
                             ...
                             <br> 
                              ...
                              <a href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/fb"><button class="loginBtn loginBtn--facebook">Login using Facebook</button></a>
                              <a href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/google"><button class="loginBtn loginBtn--google">Login using Google</button></a>
                              <!--Login Form Ends--> 
                            </div>
                          </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <img src="<?php echo url('images/wh_home_logo.png');?>">
                        </div> 
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
	...
	<script src="<?php echo e(asset('js/newWaterfall.js')); ?>"></script> 
	<script src="<?php echo e(asset('js/jquery.cookie.js')); ?>"></script> 
	<script src="<?php echo e(asset('js/jssocials.js')); ?>"></script> 
    ...
    <script>
        // Initialize Firebase
        var config = {
          apiKey: "<?php echo e(env('FIREBASE_APIKEY')); ?>",
          authDomain: "<?php echo e(env('FIREBASE_AUTHDOMAIN')); ?>",
          databaseURL: "<?php echo e(env('FIREBASE_DATABASEURL')); ?>",
          projectId: "<?php echo e(env('FIREBASE_PROJECT_ID')); ?>",
          storageBucket: "<?php echo e(env('FIREBASE_STORAGEBUCKET')); ?>",
          messagingSenderId: "<?php echo e(env('FIREBASE_MESSAGINGSENDER_ID')); ?>"
        };
      ...
      var page_lv_cat = 1;*/
       ...
       // document.cookie = "page_bc="+ page;
        ...
        if(type == "Swap")
        {
            $("#waterfall_content").empty();
        //page_sw_cat++; //page number increment
        load_more(getCookie("page_sw"),'Swap',i,getCookie("keyword"),getCookie("location"),getCookie("distance")); //load content  
          //var page = parseInt(getCookie("page_sw"));
        }
        if(type == "LocalVocal")
        {
            $("#results_lv").empty();
        //page_lv_cat++; //page number increment
        load_more(getCookie("page_lv"),'LocalVocal',i,getCookie("keyword"),getCookie("location"),getCookie("distance")); //load content   
        }
...
function update_broadcast(result)
{
    ...
    bc_tagstring += '</span>';
    bc_tagstring += '<img src="images/profile.png">';
    bc_tagstring += '</div>';
    ...
    bc_tagstring += '<p><i class="fa fa-diamond" aria-hidden="true" style="color: #3cc0c7;"></i><a target="_blank" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/user/'+result[i].user_id+'">&nbsp;'+ result[i].name+'</p>';
    bc_tagstring += '</div>';
    ...
    //sw_tagstring +='<img src="images/mobile2.png">';
    //sw_tagstring +='<img src="images/mobile2.png">';
    
     sw_tagstring +='<img src="<?php echo e((new \App\Http\Controllers\Helper)->get_swap_image_loc()); ?>'+result[i].image+'" alt="">';
    ...
    sw_tagstring +='<h4><a target="_blank" href="<?php echo e((new \App\Http\Controllers\Helper)->get_url()); ?>/swap/'+result[i].swap_id+'">'+result[i].title+'</a></h4>';
   ...
   // console.log(result);
    ...
    lv_tagstring += '<img src="images/profile.png">&nbsp;&nbsp;'+result[i].name;
    lv_tagstring += '</div>';
    ...
    lv_tagstring += '<img src="<?php echo e((new \App\Http\Controllers\Helper)->get_lv_image_loc()); ?>'+result[i].image+'">';
    lv_tagstring += '</div>';
